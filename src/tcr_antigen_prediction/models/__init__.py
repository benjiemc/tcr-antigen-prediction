...
class TCRStructMap(nn.Module):
    ...
    Args:
        ...
        cdr1_beta_length: maximum allowed length of CDR1 betas
        cdr2_beta_length: maximum allowed length of CDR2 betas
        cdr3_beta_length: maximum allowed length of CDR3 betas
    ...
    def __init__(
        ...
        *,
        ...
        cdr3_alpha_length: int = 24,
        cdr1_beta_length: int = 8,
        cdr2_beta_length: int = 8,
        cdr3_beta_length: int = 24,
        ...
        self.combined_fc = nn.Linear(
            (
                cdr1_alpha_length * peptide_length
                + cdr2_alpha_length * peptide_length
                + cdr3_alpha_length * peptide_length
                + cdr1_beta_length * peptide_length
                + cdr2_beta_length * peptide_length
                + cdr3_beta_length * peptide_length
                + cdr1_alpha_length * mhc_length
                + cdr2_alpha_length * mhc_length
                + cdr3_alpha_length * mhc_length
                + cdr1_beta_length * mhc_length
                + cdr2_beta_length * mhc_length
                + cdr3_beta_length * mhc_length
            ),
            512,
        )
    ...
    def forward(
        self,
        cdr1_alpha: torch.Tensor | None = None,  # batch_size x 8 x 20
        cdr2_alpha: torch.Tensor | None = None,  # batch_size x 8 x 20
        cdr3_alpha: torch.Tensor | None = None,  # batch_size x 24 x 20
        cdr1_beta: torch.Tensor | None = None,  # batch_size x 8 x 20
        cdr2_beta: torch.Tensor | None = None,  # batch_size x 8 x 20
        cdr3_beta: torch.Tensor | None = None,  # batch_size x 24 x 20
        peptide: torch.Tensor | None = None,  # batch_size x 12 x 20
        mhc_pseudo: torch.Tensor | None = None,  # batch_size x 26 x 20
