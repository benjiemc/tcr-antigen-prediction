...
rule run_tcr_struct_map_predictions:
    input:
        sequences="data/processed/sequences.h5",
        model="models/{model_name}"
    output: "data/processed/{model_name}_predictions_on_sequences.csv"
    resources:
        runtime="5m",
        mem="10GB",
        tasks=1
...
rule run_tcr_struct_map_predictions_cdr_peptide:
    ...
    output: "data/processed/TCRStructMap_cdrs_peptide_predictions_on_sequences.csv"
    resources:
        runtime="5m",
        mem="10GB",
        tasks=1
...
rule run_tcr_struct_map_predictions_cdr_mhc_pseudo:
    ...
    output: "data/processed/TCRStructMap_cdrs_mhc_pseudo_predictions_on_sequences.csv"
    resources:
        runtime="5m",
        mem="10GB",
        tasks=1
...
rule run_nettcr_predictions:
    input:
        ...
        model="models/NetTCR"
    output: "data/processed/NetTCR_predictions_on_sequences.csv"
    resources:
        runtime="5m",
        mem="10GB",
        tasks=1
