...
class TestGetMissingAtoms(TestCase):
    ...
    def test_3qiw(self):
        ...
        self.assertEqual(missing_atoms, [{'residue_name': 'LYS',
                                          'chain_id': 'A',
                                          'residue_seq_id': 38,
                                          'residue_insert_code': ''}])
...
class TestGetMissingResidues(TestCase):
    ...
    def test_3qiw(self):
        ...
        self.assertEqual(missing_residues, [{'residue_name': 'ILE',
                                             'chain_id': 'A',
                                             'residue_seq_id': 1,
                                             'residue_insert_code': ''},
                                            {'residue_name': 'LYS',
...
class TestTrimStartAndEnd(TestCase):
    def test(self):
        ...
        self.assertEqual(output_seq, [['A', 3, '', 'not-missing'],
                                      ['A', 4, '', 'not-missing'],
                                      ['A', 5, '', 'not-missing'],
                                      ['A', 5, 'A', 'missing'],
                                      ['A', 6, '', 'not-missing'],
...
class TestScreenTCRVariableDomain(TestCase):
    def test_3qiw(self):
        ...
        self.assertTrue(screen_tcr_variable_domain(structure,
                                                   raw_structure,
                                                   ('C', 'D'),
                                                   missing_residues,
                                                   missing_atoms))
...
class TestScreenPMHCABD(TestCase):
    def test_3qiw(self):
        ...
        self.assertFalse(screen_pmhc_abd(structure,
                                         raw_structure,
                                         'E',
                                         ('A', 'B'),
                                         'MH2',
